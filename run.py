...
tuners = ["optuna", "hyperopt"]  # "confopt"
    ...
    for config in model_configs:
        ...
        for tuner in tuners:
            ...
            for repetition in range(n_repetitions):
                ...
                historical_performance_second_aggregated["best_performance"] = (
                    historical_performance_second_aggregated.groupby(
                        ["dataset", "model", "tuner", "repetition"]
                    )["performance"].transform("cum" + time_grouping_aggregation)
                )
...
raw_benchmark_data.to_csv(f"{data_path}/raw_benchmark_data.csv")
processed_benchmark_data.to_csv(f"{data_path}/processed_benchmark_data.csv")
