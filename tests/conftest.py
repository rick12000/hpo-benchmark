...
@pytest.fixture
def plotting_spot_check_output_dir():
    """Output directory for plotting spot check artifacts."""
    base_dir = "tests/spot_checks/plotting"
    os.makedirs(base_dir, exist_ok=True)
    return base_dir
...
def multi_benchmark_raw_data(dummy_processing_raw_data):
    ...
    combined_df = pd.concat([df_original, df_duplicate], ignore_index=True)
